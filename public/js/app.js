...
/* harmony import */ var observable_membrane__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! observable-membrane */ "./node_modules/observable-membrane/dist/modules/observable-membrane.js");
...
class Component {
    constructor(el, seedDataForCloning = null) {
        ...
        this.unobservedData = seedDataForCloning ? seedDataForCloning : Object(_utils__WEBPACK_IMPORTED_MODULE_0__["saferEval"])(dataExpression, {})
    ...
    resolveBoundAttributes(el, initialUpdate = false, extraVars) {
        let attrs = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getXAttrs"])(el)
...
function handleAttributeBindingDirective(component, el, attrName, expression, extraVars) {
    ...
    } else if (Object(_utils__WEBPACK_IMPORTED_MODULE_0__["isBooleanAttr"])(attrName)) {
...
function handleForDirective(component, el, expression, initialUpdate) {
    ...
    var items
    const ifAttr = Object(_utils__WEBPACK_IMPORTED_MODULE_0__["getXAttrs"])(el, 'if')[0]
...
const Alpine = {
    ...
    clone: function (component, newEl) {
        if (! newEl.__x) {
            newEl.__x = new _component__WEBPACK_IMPORTED_MODULE_0__["default"](newEl, component.getUnobservedData())
        }
    }
}
...
/*!********************************************!*\
  !*** ./node_modules/alpinejs/src/utils.js ***!
  \********************************************/
/*! exports provided: domReady, arrayUnique, isTesting, kebabCase, walk, debounce, saferEval, saferEvalNoReturn, isXAttr, getXAttrs, isBooleanAttr, replaceAtAndColonWithStandardSyntax, transitionIn, transitionOut, transitionHelperIn, transitionHelperOut, transitionHelper, transitionClassesIn, transitionClassesOut, transitionClasses, transition */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__(/*! c:\OSPanel\domains\b0-backend\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! c:\OSPanel\domains\b0-backend\resources\sass\app.scss */"./resources/sass/app.scss");
